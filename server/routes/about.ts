...
export default defineEventHandler((event) => {
  const body = `
    ...
    <div>
      ...
      <p>
        This tiny service is a <strong>Nitro</strong> playground used to test how
        Forgeon talks to functions: health checks, routes, timeouts, and log streaming.
      </p>
      <p>
  ...
  return htmlShell('Forgeon · About this Nitro demo', body)
})
